...
class Dog extends Mammal {
    ...
    public void eat() {
        super.eat();
        System.out.println("Dog is eating and wagging tail");
    }
    ...
    public void showLoyalty() {
        System.out.println("Dog's loyalty level is: " + loyaltyLevel + "/10");
    }

    // Demonstrate inheritance chain
    public void demonstrateInheritance() {
        System.out.println("\n--- Inheritance Demonstration ---");
        super.eat(); // Animal-level
        super.move(); // Mammal-level + Animal-level
        super.sleep(); // Animal-level
        this.bark();  // Dog-level
    }
    ...
    public static void main(String[] args) {
        ...
        Dog dog1 = new Dog(); // Basic dog
        Dog dog2 = new Dog("Dog", "House", 15, false,
                           "Brown", 65, "Labrador", true, 9, "Fetching ball");
        ...
        // 3. Test inherited methods & fields
        System.out.println("\n--- Inherited Members Test ---");
        System.out.println(dog2.getAnimalInfo());
        dog2.nurse();
        dog2.regulateTemperature();

        // 4. Dog-specific methods
        System.out.println("\n--- Dog-Specific Methods Test ---");
        dog2.bark();
        dog2.fetch();
        dog2.showLoyalty();

        // 5. Demonstrate chain of inheritance
